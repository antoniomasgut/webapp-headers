...
import org.daw.apiservlet.webapp.headers.models.Producto;
import org.daw.apiservlet.webapp.headers.services.ProductoService;
import org.daw.apiservlet.webapp.headers.services.ProductoServiceImpl;
...
public class ProductoJsonServlet_3 extends HttpServlet {
    @Override
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        ObjectMapper mapper = new ObjectMapper();
        String json = mapper.writeValueAsString(productos);// Obte un string amb format JSON a partir d'un objecte
